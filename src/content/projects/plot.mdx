...
<Prescii label="An extension turns external state into work items; Plot schedules agent runs that act through extension tools"><span class="fg-yellow">{`external system
      |
   discover
      v
+-----------+   Work Items   +-----------+
...
<Prescii label="Plot discovery outcomes and their scheduling effects"><span class="fg-red">{`pending    | dispatch
